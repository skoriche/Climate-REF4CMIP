...
@current_app.task
def handle_result(result: MetricResult, metric_execution_result_id: int) -> None:
    """
    ...
    with db.session.begin():
        metric_execution_result = db.session.get(MetricExecutionResult, metric_execution_result_id)
